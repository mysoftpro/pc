...
var storeDesc = function(code){
	...
	$jq.ajax({
			 ...
			 $jq.ajax({
				      ...
				      data:{'op':'descr','code':code, 'desription':data,'key':'acafcba083d188a9465c8a9c590015e7'}
				    });
		     }
		 });
    }
...
var storeSingleDesc = function(code){
	...
	$jq.ajax({
			 ...
			 $jq.ajax({
				      type: 'POST',
				      url:'http://localhost/xml',
				      data:{'op':'descr','code':code, 'desription':data, 'key':'a68ef0ea90b595cf6a77bf0566000f2c'}
				    });
		     }
		 });
    }
