	 ...
	 return this.each(
		 ...
		 if (isScrollable) {
			 ...
			 $('<div></div>')
			     ...
			     .attr({'class':'jScrollPaneTrack'})
			     .css({'width':settings.scrollbarWidth+'px'}).append(
			     $('<div></div>')
				     //tretiy3
				     //.attr({'className':'jScrollPaneDrag'})
				     .attr({'class':'jScrollPaneDrag'})
				     .css({'width':settings.scrollbarWidth+'px'}).append(
				 $('<div></div>')
					      //tretiy3
					      //.attr({'className':'jScrollPaneDragTop'})
					     .attr({'class':'jScrollPaneDragTop'})
					     .css({'width':settings.scrollbarWidth+'px'}),
				 $('<div></div>')
					      //tretiy3
					     //.attr({'className':'jScrollPaneDragBottom'})
					     .attr({'class':'jScrollPaneDragBottom'})
					     .css({'width':settings.scrollbarWidth+'px'})
			     )
			 ),
