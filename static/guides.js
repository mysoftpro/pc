...
var init = function(){
    ...
    $('#tips').click(function(e){
			 ...
			 guider.createGuider({
						 attachTo: "#proclock",
						 description: "Если вы точно знаете какой процессор или материнская плата вам нужна, можно зафиксировать выбор, и тогда при нажатии кнопок Дешевле и Лучше не будет происходить замены этого компонента. Выбор материнской платы ограничится соответсвующим процессору сокетом.",
						 id: "mother",
						 position: 7,
						 width: 360
					     }).show();
